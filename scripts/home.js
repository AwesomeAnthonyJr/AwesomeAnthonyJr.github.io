...
function updateCaroDescription() {
  ...
  switch (caro_index) {
    //case 2:
    //  descriptionBG.className =  'carousel-description-background-DUI';
    //  descriptionTX.className =  'carousel-description-text-DUI';
    //  descriptionCR.className =  'carousel-description-credit-DUI';
    //  
    //  descriptionTX.innerHTML = `<p>DUI: Drive Until Impact is a physics-based car racing and crashing game originally created for Untitled Game Jam #116. Take control of a futuristic hovercar and go out and crash into various enemy cars in order to increase your car's stats in order to go out and take on the 3 regional bosses who rule the land. See how fast you can defeat the bosses in this uniquely destructive take on a racing game. You can play DUI: Drive Until Impact for free today by downloading it from its <a href="https://leaflight-studios.itch.io/xcvb">itch.io</a> page, or <a href="https://leaflight-studios.itch.io/">learn more about it here.</a></p>`;
    //  descriptionCR.innerHTML = `<p>Created By: Anthony D. Salsbury,<br> Others </p>`
    //  break;
    case 2: //3:
...
async function updateTitle() {
  ...
  switch (caro_index) {
    //case 2:
    //  await type(title, "DUI: Drive Until Impact", 20);
    //  break;
    case 2: //3:
...
function updateRelease() {
  ...
  switch (caro_index) {
    //case 2:
    //  type(release, "September 28th 2025", 20);
    //  break;
    case 2: //3:
...
async function updateMobileDescription() {
  ...
  switch (caro_index) {
    // case 2:
    //  description.innerHTML = `<h2>DUI: Drive Until Impact</h2> <h3>September 28th 2025</h3> <br> <p>DUI: Drive Until Impact is a physics-based car racing and crashing game originally created for Untitled Game Jam #116. Take control of a futuristic hovercar and go out and crash into various enemy cars in order to increase your car's stats in order to go out and take on the 3 regional bosses who rule the land. See how fast you can defeat the bosses in this uniquely destructive take on a racing game. You can play DUI: Drive Until Impact for free today by downloading it from its <a href="https://leaflight-studios.itch.io/xcvb">itch.io</a> page, or <a href="https://leaflight-studios.itch.io/">learn more about it here.</a></p> <br> <h3>Created By: Anthony D. Salsbury, Owen Hickman, & Samuel Radulski and more</h3>`;
    //  break;
    case 2: //3:
      description.innerHTML = `<h2>XCVB</h2> <h3>May 25th 2025</h3> <br> <p>XCVB is a roguelike deckbuilder / 2D platformer mashup originally created for Untitled Game Jam #110. You play as a lone gambler with a deck of magical cards who ascend's Starface's tower in order to reclaim the $5 they are owed. Featuring 16 different movement cards (for active abilities), and 24 different badges (for passive perks), There are countless combinations to discover. The enemies in the tower get stronger as you climb, but on your own terms, as you get to decide if they become faster or stronger each floor. You can play XCVB for free today on its <a href="https://leaflight-studios.itch.io/xcvb">itch.io</a> page, or <a href="https://leaflight-studios.itch.io/">learn more about it here.</a></p> <br> <h3>Created By: Anthony D. Salsbury, Owen Hickman, & Samuel Radulski</h3>`;
      break;
    case 3: //4:
      ...
      break;
    case 4: //5:
      description.innerHTML = `<h2>Mage Hand</h2> <h3>July 31st 2024</h3> <br> <p>Mage Hand is a knowledge-based exploration game originally created for Pirate Software Game Jam #15. You are a magician who has lost your memory, but retained your ability to cast spells via different hand signs. Explore out of the prison tower and find your way out of the mansion, with secret routes and legendary wizards, reclaim your memory and master some of the 40 different spells to defeat your captor and set yourself free. You can play Mage Hand for free directly from its <a href="https://leaflight-studios.itch.io/mage-hand">itch.io</a> page, or <a href="https://leaflight-studios.itch.io">learn more here</a></p> <br> <h3>Created By: Anthony D. Salsbury, Josh "BB" Bang, Willow Bradshaw</h3>`;
      break;
    case 5: //6:
      description.innerHTML = `<h2>goblin knight</h2> <h3>May 11th 2024</h3> <br> <p>goblin knight is an experimental 1st person sword fighting game initially created for the Game Idea Jam 2024. Play as an explorer who has gone too deep in the dark, meeting the goblin knight. It displays an interesting idea with it's aiming-based melee combat. You can download goblin knight for free from its <a href="https://leaflight-studios.itch.io/goblin-knight">itch.io</a> page, or <a href="https://leaflight-studios.itch.io">learn more here</a></p> <br> <h3>Created By: Anthony D. Salsbury</h3>`;
      break;
    case 6: //7:
      ...
      break;
    case 7: //8:
      description.innerHTML = `<h2>SHAHARAZON</h2> <h3>March 14th 2024</h3> <br> <p>SHAHARAZON is a first person "grenadier" set in the dark future of 2424, originally created for Acerola Jam 0. Play through a simulation of the war of the future as a cyborg super-soldier, trained for combat in grenade-only situations. You can play SHAHARAZON for free by downloading it from its <a href="https://leaflight-studios.itch.io/agj0project">itch.io</a> page, or <a href="https://leaflight-studios.itch.io">learn more here</a></p> <br> <h3>Created By: Anthony D. Salsbury</h3>`;
      break;
    default:
      console.log("unexpected!");  
  }

  mobileExpandButton.textContent = "View Description -";
