...
function updateCaroDescription() {
  ...
  switch (caro_index) {
    case 2:
      ...
      descriptionTX.innerHTML = `<p>DUI: Drive Until Impact is a cool game</p>`;
...
async function updateMobileDescription() {
  ...
  switch (caro_index) {
     case 2:
      description.innerHTML = `<h2>DUI: Drive Until Impact</h2> <h3>September 28th 2025</h3> <br> <p>DUI desc</p> <br> <h3>Created By: Anthony D. Salsbury, Owen Hickman, & Samuel Radulski and more</h3>`;
      break;
    case 3:
